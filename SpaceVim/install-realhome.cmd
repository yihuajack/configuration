...
$repo_name   = "SpaceVim"
$repo_path   = "E:\Cadence\SPB_Data\.SpaceVim"
...
if (!(Test-Path "E:\Cadence\SPB_Data\.SpaceVim")) {
  echo "==> 正在安装 $app_name"
...
echo ""
if (!(Test-Path "E:\Cadence\SPB_Data\vimfiles")) {
  cmd /c mklink E:\Cadence\SPB_Data\vimfiles $repo_path
  echo "[OK] 已为 vim 安装 SpaceVim"
  sleep 1
} else {
  echo "[OK] E:\Cadence\SPB_Data\vimfiles 已存在"
  sleep 1
}

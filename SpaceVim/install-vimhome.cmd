...
echo ""
if (!(Test-Path "D:\Documents\Programming\vimhome\vimfiles")) {
  cmd /c mklink D:\Documents\Programming\vimhome\vimfiles $repo_path
  echo "[OK] 已为 vim 安装 SpaceVim"
  sleep 1
} else {
  echo "[OK] D:\Documents\Programming\vimhome\vimfiles 已存在"
  sleep 1
}

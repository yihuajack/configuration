...
$repo_name   = "SpaceVim"
$repo_path   = "D:\Documents\Programming\vimhome\SpaceVim"
...
if (!(Test-Path "D:\Documents\Programming\vimhome\SpaceVim")) {
  echo "==> 正在安装 $app_name"
...
echo ""
if (!(Test-Path "D:\Documents\Programming\vimhome\SpaceVim")) {
  cmd /c mklink D:\Documents\Programming\vimhome\SpaceVim $repo_path
  echo "[OK] 已为 vim 安装 SpaceVim"
  sleep 1
} else {
  echo "[OK] D:\Documents\Programming\vimhome\SpaceVim 已存在"
  sleep 1
}

echo ""
if (!(Test-Path "C:\Users\Yihua\AppData\Local\nvim")) {
  cmd /c mklink "C:\Users\Yihua\AppData\Local\nvim" $repo_path
  echo "[OK] 已为 neovim 安装 SpaceVim"
  sleep 1
} else {
  echo "[OK] C:\Users\Yihua\AppData\Local\nvim 已存在"
  sleep 1
}
